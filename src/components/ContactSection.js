      ...
      <Card className="contact-card" bordered={false}>
        <div>
          ...
          <Paragraph className="section-copy">
            I love tackling ambiguous problems, elevating product vision, and shipping polished experiences.
          </Paragraph>
        </div>
        <Space className="cta-row" wrap>
          ...
          <Button type="default" size="large" href="#projects" className="ghost-button">
            See more work
          </Button>
        </Space>
      </Card>
